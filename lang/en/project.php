...
return [
    ...
    'host' => [
        ...
        'cpu_chart' => 'CPU %',
        'memory_chart' => 'Memory %',
        'details_cpu' => 'CPU detail',
        'details_memory' => 'Memory detail',
        'details_disk' => 'Disk detail',
        'usage' => 'Usage',
        'cores' => 'Cores',
        'load_avg' => 'Load (1/5/15m)',
        ...
        'processes_title' => 'Top processes (CPU ∪ memory)',
        'processes_empty' => 'No process data yet — it arrives with the next host sample (Linux only).',
        'col_process' => 'Process',
        'col_pid' => 'PID',
        'col_cpu' => 'CPU',
        'col_memory' => 'Memory',
