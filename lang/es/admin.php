...
return [
    ...
    'projects' => [
        ...
        // Purga de datos por tipo (recupera espacio que una métrica desactivada ya usó)
        'purge_title' => 'Limpiar datos guardados por tipo',
        'purge_help' => 'Elimina permanentemente todos los eventos y rollups de un tipo en este proyecto. Útil justo después de desactivar una métrica, para recuperar el espacio que ya consumió. Otros tipos y el historial de incidentes se conservan.',
        'purge_select_label' => 'Tipo de métrica',
        'btn_purge_type' => 'Limpiar datos',
        'confirm_purge' => '¿Eliminar permanentemente TODOS los datos de :type (eventos + rollups) de este proyecto? Esto no se puede deshacer.',
        'purged' => ':count filas eliminadas de :type.',
        'purge_unknown_type' => 'Tipo de métrica desconocido.',
    ...
    'edit' => [
        ...
        'raw_retention_label' => 'Retención de eventos brutos (días)',
        'agg_retention_label' => 'Retención de agregados (días)',
        'retention_inherit' => 'Heredar global',
        'retention_help' => 'Retención por proyecto. Déjalo en blanco para heredar la ventana global. Un valor solo acorta la retención por debajo del techo global (privacidad / costo) — no puede extenderla.',
    ...
    'api_tokens' => [
        ...
        'subheading' => 'Tokens de solo lectura para automatización y dashboards externos',
        'new_token' => 'Nuevo token — cópialo ahora, no se mostrará de nuevo',
        'name_placeholder' => 'Nombre del token (p. ej. status-page)',
        'create' => 'Crear token',
    ...
    'settings' => [
        ...
        'rules_title' => 'Reglas de alerta',
        'rules_help' => 'Abre un incidente cuando una métrica cruza un umbral en una ventana. Se evalúan junto con las reglas del config.',
        'rules_name' => 'Nombre de la regla',
