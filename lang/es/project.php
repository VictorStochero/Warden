...
return [
    ...
    'errors' => [
        ...
        'release_all' => 'Todas',
        'since_deploy_title' => 'Desde el último deploy',
        'since_deploy_throughput' => 'Solicitudes',
        'since_deploy_errors' => 'Errores 5xx',
        'since_deploy_error_rate' => 'Tasa de error',
        'since_deploy_new_issues' => 'Nuevas issues',
    ],
    ...
    'logs' => [
        ...
        'search' => 'Buscar',
        'search_placeholder' => 'Buscar en los mensajes de log…',
    ],
    ...
    'requests' => [
        ...
        'show_panel' => 'Mostrar solicitudes del panel',
        'hide_panel' => 'Ocultar solicitudes del panel',
    ],
