...
return [
    ...
    'host' => [
        ...
        'details_cpu' => 'Detalle de CPU',
        'details_memory' => 'Detalle de memoria',
        'details_disk' => 'Detalle de disco',
        'usage' => 'Uso',
        'cores' => 'Núcleos',
        'load_avg' => 'Carga (1/5/15m)',
        'sampled_at' => 'Muestreado a las',
        'used' => 'Usado',
        'available' => 'Disponible',
        'free' => 'Libre',
        'total' => 'Total',
        'swap' => 'Swap (usado / total)',
        'processes_title' => 'Procesos principales (CPU ∪ memoria)',
        'processes_empty' => 'Aún sin datos de procesos — llegan con la próxima muestra del host (solo Linux).',
        'col_process' => 'Proceso',
        'col_pid' => 'PID',
        'col_cpu' => 'CPU',
        'col_memory' => 'Memoria',
