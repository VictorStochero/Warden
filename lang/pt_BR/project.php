...
return [
    ...
    'host' => [
        ...
        'details_cpu' => 'Detalhe de CPU',
        'details_memory' => 'Detalhe de memória',
        'details_disk' => 'Detalhe de disco',
        'usage' => 'Uso',
        'cores' => 'Núcleos',
        'load_avg' => 'Carga (1/5/15m)',
        'sampled_at' => 'Amostrado às',
        'used' => 'Usado',
        'available' => 'Disponível',
        'free' => 'Livre',
        'total' => 'Total',
        'swap' => 'Swap (usado / total)',
        'processes_title' => 'Principais processos (CPU ∪ memória)',
        'processes_empty' => 'Ainda sem dados de processos — chegam na próxima amostra do host (somente Linux).',
